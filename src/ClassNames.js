...
export const VILLAGER_PROFESSION = PKG.DATA + '.VillagerProfession'
export const VILLAGER_TYPE = PKG.DATA + '.VillagerType'
...
export const ENTITY_MOB = PKG.ENTITY + '.Mob'
...
export const BIOME$SPAWN_LIST_ENTRY = BIOME + '$SpawnListEntry'
...
export const WORLD_CLIENT = PKG.CLIENT_MULTIPLAYER + '.ClientWorld'
...
export const CRASH_REPORT_CATEGORY = PKG.CRASH + '.CrashReportCategory'
...
export const ADVANCEMENT_TRIGGER_KILLED_BY_CROSSBOW = PKG.ADVANCEMENT_TRIGGERS + '.KilledByCrossbow'
...
export const SPAWN_REASON = PKG.WORLD + '.SpawnReason'
...
export const RAID = PKG.VILLAGE + '.Raid'
export const RAIDS = PKG.VILLAGE + '.Raids'
export const RAIDER = PKG.ENTITY_MONSTER + '.Raider'
