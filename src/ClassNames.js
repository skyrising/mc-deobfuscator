...
export const PACKET_LOGIN_HELLO = PKG.NETWORK_LOGIN_CLIENT + '.C2SHello'
export const PACKET_LOGIN_KEY = PKG.NETWORK_LOGIN_CLIENT + '.C2SKey'
export const PACKET_ENTITY_PROPERTIES = PKG.NETWORK_PLAY_SERVER + '.S2CEntityProperties'
