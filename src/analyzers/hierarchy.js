...
const PACKAGE_MAP = {
  ...
  [CLASS.SERVER_WORLD]: PKG.SERVER_WORLD,
  [CLASS.CONTAINER]: PKG.CONTAINER,
  [CLASS.RECIPE]: PKG.RECIPE,
  [CLASS.RECIPE_TYPE]: PKG.RECIPE,
  [CLASS.RECIPE_SERIALIZER]: PKG.RECIPE
}
  ...
  */
  if (clsInfo.isInnerClass) {
    ...
    if (clsInfo.superClassName === info.classReverse[CLASS.ADVANCEMENT_ABSTRACT_CRITERION_INSTANCE] && clsInfo.outerClass.name) {
      return clsInfo.outerClass.name + '$Conditions'
    }
  }
}
