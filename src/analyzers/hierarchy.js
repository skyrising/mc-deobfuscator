...
const SUPERCLASS_MAP = {
  ...
  [CLASS.VILLAGER_GOLEM]: CLASS.ENTITY_GOLEM,
...
export function init (info) {
  info.on('class-name', ({obf, deobf, clsInfo}) => {
